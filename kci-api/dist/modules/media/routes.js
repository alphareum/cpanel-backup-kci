...
async function storeFileLocally(folder, fileName, buffer) {
...
async function storeFileInSupabase(folder, fileName, buffer, mimeType) {
...
export async function mediaRoutes(server) {
